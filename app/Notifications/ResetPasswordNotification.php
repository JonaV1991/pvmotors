    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
           ...
           ->subject(Lang::getFromJson('Restablecer Contraseña'))
            ...
            ->line(Lang::getFromJson('Este enlace de restablecimiento de contraseña caducará en: contar minutos.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
